...
public class MeasurementPreview extends View {

	private List<Orientation> orientations = new ArrayList<Orientation>();
	private static Room room;

	public MeasurementPreview(Context context, float[] points) {
		super(context);
	}

	public MeasurementPreview(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
